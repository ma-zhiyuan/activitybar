		...
		<div class="login-main">
			<form action="admin/login" class="layui-form" method="post">
				...
				<div class="layui-form-item">
					...
					</label> <input type="text" name="name" lay-verify="userName"
						autocomplete="off" placeholder="这里输入登录名" class="layui-input">
				</div>
				<div class="layui-form-item">
					<label class="login-icon"> <i class="layui-icon">*</i>
					</label> <input type="password" name="pwd" lay-verify="password"
